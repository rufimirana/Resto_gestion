 ...
 * @author jayks
 */
public class TraitementPaiement extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TraitementPaiement</title>");            
            out.println("</head>");
            out.println("<body>");
            try {
                HttpSession session = request.getSession(true);
                int grade = Integer.parseInt(session.getAttribute("grade").toString());
                int id_detailsCommande = Integer.valueOf(request.getParameter("id").trim());
                ...
                p.insertPaiement(id_modePaiement, id_detailsCommande, montant);
                dc.updateEtatPayer();
            ...
            out.println("<h1>Servlet TraitementPaiement at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
