 ...
 * @author jayks
 */
public class TraitementCuisine extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TraitementCuisine</title>");            
            out.println("</head>");
            out.println("<body>");
            try {
                ...
                RequestDispatcher dispatch = request.getRequestDispatcher("Cuisine.jsp");
