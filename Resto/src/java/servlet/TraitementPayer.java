 ...
 * @author jayks
 */
public class TraitementPayer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TraitementPayer</title>");            
            out.println("</head>");
            out.println("<body>");
            try {
                ...
                RequestDispatcher dispatch = request.getRequestDispatcher("ModedePaiement.jsp");
                dispatch.forward(request,response);
            } catch (Exception e) {
                out.println("<h1>Erreur : " + e.getMessage() + "</h1>");
            }
            out.println("<h1>Servlet TraitementPayer at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
