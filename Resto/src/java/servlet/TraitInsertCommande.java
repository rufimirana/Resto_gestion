 ...
 * @author jayks
 */
public class TraitInsertCommande extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TraitInsertCommande</title>");            
            out.println("</head>");
            out.println("<body>");
            try {
               HttpSession session = request.getSession(true);
               int grade = Integer.parseInt(session.getAttribute("grade").toString());
               int idT = Integer.valueOf(request.getParameter("table").trim());
               Commande c = new Commande();
               c.insertCommandes(idT);
