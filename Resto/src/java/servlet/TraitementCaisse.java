 ...
 * @author jayks
 */
public class TraitementCaisse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TraitementCaisse</title>");            
            out.println("</head>");
            out.println("<body>");
            try {
                ...
                RequestDispatcher dispatch = request.getRequestDispatcher("Caisse.jsp");
               dispatch.forward(request,response);
            } catch (Exception e) {
            }
            out.println("<h1>Servlet TraitementCaisse at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
