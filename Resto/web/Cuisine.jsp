<%-- 
    Document   : Cuisine
    Created on : 4 avr. 2022, 16:19:00
    Author     : jayks
--%>
                        ...
                        <div>
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table">
                                        <td >
                                            <% out.println(listeAll.get(i).getNom_produit()); %>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="http://localhost:8080/Resto/TraitementPret?id=<% out.println(listeAll.get(i).getId_detailsCommande());%>">Pret</a>
                                        </td>
                                        </tr>
                                    <% }%>
                                </tbody>
