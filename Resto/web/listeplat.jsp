<%-- 
    Document   : listeplat
    Created on : 22 mars 2022, 10:59:33
    Author     : jayks
--%>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                    <%if(grade == 1) { %>
                        ...
                        <div class="dropdown">
                            <form action="http://localhost:8080/Resto/TraitementListePlat" method="get">
                                <select name="categorie">
                                    <option value = "#">Categorie
                                    <% for(int i = 0; i <listeCategorie.length ; i++) { %>
                                        <option value = "<% out.println(listeCategorie[i].getId_categorie()); %>"><%  out.println(listeCategorie[i].getNom_categorie()); %>
                                    <% } %> 
                                </select>
              ...
              <table class="table">
                  ...
                  <tbody>
                      ...
                      <tr class="table">
                          <td >
                              <a href="<% out.println("http://localhost:8080/Resto/TraitementRecette?id_produit="+listeProduit[i].getId_produit()); %>"><% out.println(listeProduit[i].getNom_produit()); %></a>
                          </td>
                          <td>
